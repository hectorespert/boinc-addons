...
class _RPCClientRaw:
    ...
    # Upstream never closes the connection, so a caller that polls leaks one socket per cycle and
    # relies on the garbage collector to reap it. BOINC also caps concurrent GUI RPC connections.
